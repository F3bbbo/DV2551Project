...
//	camera->getposition();
		...
		Vector3 lengthofvector =	camera->getPosition() - Vector3(walkingpath[0].x, walkingpath[0].y, -100);
		...
		Vector3 move = (Vector3(walkingpath[0].x, walkingpath[0].y, -100) - camera->getPosition());
		if(lengthDist>0.1)
